				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="alert alert-info mb-0" role="alert">
							<p class="mb-0"><?php echo $row->long_title?></p>
						</div>
					</div>
				</div>
			</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="<?php echo base_url()?>assets/images/business/<?php echo $row->logo?>" alt="image"                                        class="img-fluid wid-100 mb-2">															
                        ...
                        <div style="text-align: center" class="table-responsive">
                            <table class="table table-sm mb-0">
                                <tbody>
									...
									<br>
                                    <tr>
											<textarea disabled style="font-size: 1.5em" name="long_title" class="form-control" id="description" rows="5">  <?php echo $row->long_description?>
											</textarea>
                                    </tr>
									<br>
									<br>
						...
						<div class="row">
							...
							<a href="<?php echo site_url('We_serve/edit_content/'.$title_after.'/'.$industries_id)?>"><button style="text-align: center" class="btn btn-primary feather">Read more >></button></a>
							<div class="col-sm-1">
							</div>
							<a href="<?php echo site_url('We_serve/delete_content/'.$row->industries_id)?>"><button style="text-align: center" class="btn btn-danger feather icon-trash-2" onClick="return confirm('Are you sure you want to delete this card?')">Delete</button></a>
							<div class="col-sm-3">
							</div>
						</div>
                    </div>
...
<div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
			...
			<form action="<?php echo site_url('We_serve/insert_content')?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
						...
						<div style="text-align: center" class="col-sm-6">
							<div class="form-group">
								...
								<div>
									<input type="file" name="userfiles2" class="validation-file" name="validation-file">
								</div>
							</div>
                        ...
                        <div style="text-align: center" class="col-sm-6">
							...
							<div class="form-group">
								...
								<div>
									<input type="file" name="userfiles" class="validation-file" name="validation-file">
								</div>
							</div>
						</div>
						<div style="text-align: center" class="col-sm-3">
						...
						<div class="col-sm-12">
			   			...
			   			<div style="text-align: center" class="col-sm-6">
							...
							<div class="form-group">
								<label class="form-label">photo</label>
								<div>
									<input type="file" name="userfiles3" class="validation-file" name="validation-file">
								</div>
							</div>
						</div>
						<div style="text-align: center" class="col-sm-3">
