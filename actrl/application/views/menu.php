		...
		<div class="navbar-content scroll-div " >
				<div class="">
					<div class="main-menu-header">
						<img class="img-radius" src="<?php echo base_url()?>assets/images/GCS Logo-01.png" alt="logo">
					...
					<div class="collapse" id="nav-user-link">
						<ul class="list-inline">
							<li class="list-inline-item"><a href="<?php echo site_url('Home/destroy_session')?>" data-toggle="tooltip" title="Logout" class="text-danger"><i class="feather icon-power"></i></a></li>
						</ul>
					</div>
				</div>
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-handshake"></i></span><span class="pcoded-mtext">Industries we serve</span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo site_url()?>/We_serve/edit_we_serve">Head page</a></li>
							<li><a href="<?php echo site_url()?>/We_serve/get_content">Content</a></li>
						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-hand-holding-usd"></i></span><span class="pcoded-mtext">Loan options</span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo site_url()?>/Loan_solution/edit_loan_solution">Head page</a></li> 
							<li><a href="<?php echo site_url()?>/Loan_solution/get_content">Content</a></li>
						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-comment-dollar"></i></span><span class="pcoded-mtext">Blogs</span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo site_url('Blog/')?>">Blog</a></li>
							<li><a href="<?php echo site_url('Blog/search_blog')?>">Search</a></li>
						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="fa fa-check-square" style="font-size:24pxpx; padding: 10px"></span><span class="pcoded-mtext">apply online </span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo site_url()?>/Apply_online/edit_apply_online">Head page</a></li> 
							<li><a href="<?php echo site_url()?>/Apply_online/get_content">Content</a></li>
<!--
							<li><a href="<?php echo site_url()?>/Apply_online/get_loans">get_loans</a></li>
							<li><a href="<?php echo site_url()?>/Apply_online/loans_search">loans_search</a></li>
-->

						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="<?php echo site_url()?>/About_us/edit_about_us" class="nav-link "><span class="pcoded-micon"><i class="feather icon-info"></i></span><span class="pcoded-mtext">About us</span></a>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="<?php echo site_url()?>/Contact_us/edit_contact_us" class="nav-link "><span class="pcoded-micon"><i class="feather icon-phone-incoming"></i></span><span class="pcoded-mtext">Contact us</span></a>
					</li>
					<li class="nav-item pcoded-hasmenu">
					...
					<li class="nav-item pcoded-hasmenu">
						<a href="<?php echo site_url()?>/Privacy_policy" class="nav-link "><span class="pcoded-micon"><i class="fas fa-fingerprint"></i></span><span class="pcoded-mtext">Privacy Policy</span></a>
					</li>
					
<!--
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-image"></i></span><span class="pcoded-mtext">Photo Gallery</span></a>
						<ul class="pcoded-submenu">
							 <li><a href="<?php echo site_url()."/Photo_gallery/get_albums/";?>">Photo Gallery</a></li>
						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link"><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">User</span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo site_url('Users/users_search')?>">User Search</a></li>
							<li><a href="<?php echo site_url('Users/user_list')?>">User List</a></li>
							<li><a href="<?php echo site_url()."/Users/member_list/";?>">Member List</a></li>
						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-laptop"></i></span><span class="pcoded-mtext">Courses</span></a>
						<ul class="pcoded-submenu">
							 <li><a href="<?php echo site_url()."/Courses/get_categories/";?>">Categories</a></li>
							 <li><a href="<?php echo site_url()."/Courses/get_courses_reviews/";?>">Courses Review</a></li>
						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-clipboard"></i></span><span class="pcoded-mtext">Task</span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo site_url()."/Task/get_task/";?>">List</a></li>
							<li><a href="task-board.html">Board</a></li>
							<li><a href="task-detail.html">Detail</a></li>
						</ul>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fas fa-video"></i></span><span class="pcoded-mtext">Videos</span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo site_url()."/Video_library_albums/get_albums/";?>">Albums video</a></li>
							<li><a href="gallery-masonry.html">Masonry</a></li>
						</ul>
					</li>
					</li>
					<li class="nav-item pcoded-menu-caption">
						<label>Admin Panel<span class="pcoded-badge badge badge-danger">HOT</span></label>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link"><span class="pcoded-micon"><i class="fas fa-book-dead"></i></span><span class="pcoded-mtext">Permission</span></a>
						<ul class="pcoded-submenu">
							<li><a href="<?php echo site_url('Permission/get_roles')?>">Roles</a></li>
							<li><a href="<?php echo site_url('Permission/view_permission')?>">Permissions</a></li>
						</ul>
					</li>
-->
<!--
					<li class="nav-item pcoded-hasmenu styled-icons icon-bordered icon-rounded clearfix">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="fa fa-cc"></i></span><span class="pcoded-mtext">Dashboard</span></a>
						<ul class="pcoded-submenu">
							<li><a href="">اشعارات</a></li>
						</ul>
					</li>
-->
<!--
