					...
					<div class="row align-items-center">
						<div class="col-md-12">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="<?php echo site_url('Blog/search_result_blog') ?>"> Search Result</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<tbody>
			 ...
			 <?php $x=1;
			  ...
			  <tr role="row" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align: center; black: goldenrod">
				 ...
				 <td > <?php echo $row->description_blog ?>
