		...
		<div class="row align-items-center">
			<div class="col-md-12">
				...
				<ul class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo site_url('Blog/search_blog') ?>"> Search</a></li>
...
<div class="row btn-page">
	...
	<div class="col-sm-12">
		...
		<form action="<?php echo site_url('Blog/update_blog_sess')?>" method="post" enctype="multipart/form-data">
			<div class="card">
