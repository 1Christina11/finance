<div class="carousel slide" id="main-slide" data-ride="carousel">
         ...
         <div class="carousel-inner">
            <div class="carousel-item active" style="background-image:url(<?php echo base_url()?>assets/images/slider/bg1.jpg);">
               <div class="container">
            ...
            <!-- Carousel item 1 end-->
            <div class="carousel-item" style="background-image:url(<?php echo base_url()?>assets/images/slider/bg2.jpg);">
               <div class="container">
            ...
            <!-- Carousel item 1 end-->
            <div class="carousel-item" style="background-image:url(<?php echo base_url()?>assets/images/slider/bg3.jpg);">
               <div class="container">
