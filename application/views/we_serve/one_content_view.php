            ...
            <div class="row justify-content-center">
               <div class="col">
                  <div class="banner-heading">
					 ...
					 <div class="row">
						 <div class="col-12">
						   <h2 style="text-align: center; color:goldenrod" class="addons-title"><?php echo $industries_content->title?></h2>
						 </div>
					 </div>
				     <br>
					  ...
					  <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('We_serve/get_we_serve')?>">Industries we serve</a></li>
                     </ol>
                  </div>
               </div>
               <!-- Col end-->
         ...
         <div class="ts-case-challange" id="ts-case-challange">
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-lg-8">
					<div class="heading">
					   <h3 style="text-align:center" class=" content-title border-none"><?php echo $industries_content->title?></h3>
					</div>
                     <div class="case-single-img text-right">
                        <img class="img-fluid" src="<?php echo base_url()?>/actrl/assets/images/business/<?php echo $industries_content->logo?>" alt="">
                     </div>
                  </div>
                  <div class="col-lg-2">
                  </div>
                  <div class="col-lg-12">
                     ...
                     <div class="case-details-inner">
                        <div class="ts-text-block">
                           <p><?php echo $industries_content->short_description?></p>
                        </div>
                        <div class="ts-text-block">
                           <p><?php echo $industries_content->long_description?></p>
					  	   <a class="btn btn-primary" href="<?php echo site_url('Apply_online')?>">Apply now</a>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-6">
					<div class="heading">
                     ...
                     <div class="case-single-img text-left">
                        <img class="img-fluid" src="<?php echo base_url()?>/actrl/assets/images/business/<?php echo $industries_content->photo_1?>" alt="">
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="case-details-inner">
                        <div class="ts-text-block">
							 <h2 class=" content-title border-none"><?php echo $industries_content->title_photo_1?></h2>
                           <p><?php echo $industries_content->photo_description_1?></p>
               			   <div class="row">
						       <div class="col-lg-3">
							   </div>
							   <div class="col-lg-6">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-6">
                     <div class="case-details-inner">
                        <div class="heading">
                           <h3 class=" content-title border-none"> <?php echo $industries_content->title_photo_2?> </h3>
                        </div>
                        <div class="ts-text-block">
                           <p><?php echo $industries_content->photo_description_2?></p>
                        </div>
                     </div>
<!--
                     <div class="row">
...
-->				     
                  ...
                  <div class="col-lg-6 text-right">
                     <div class="single-case-img">
                        <img class="img-fluid" src="<?php echo base_url()?>/actrl/assets/images/business/<?php echo $industries_content->photo_2?>" alt="">
                     </div>
                  </div>
               </div>
            </div>
